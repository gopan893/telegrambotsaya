...
async function run() {
  ...
  const routeFile = path.join(ROOT, 'src/dashboard/rag-quality-routes.js');
  check(fs.existsSync(routeFile), 'rag-quality-routes.js exists');
  ...
  console.log('\n--- RAG Quality Dashboard API: ' + passed + ' passed, ' + failed + ' failed ---');
