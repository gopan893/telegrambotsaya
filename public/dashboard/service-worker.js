...
const CACHE_NAME = 'telegram-aios-dashboard-static-v48-stability-audit';
const STATIC_ASSETS = [
  '/dashboard',
  ...
  '/dashboard/telegram-control.js',
  '/dashboard/research.js',
  '/dashboard/lifeos.js',
  ...
  '/dashboard/docs-intel.js',
  '/dashboard/model-router.js',
  '/dashboard/plugins.js',
  '/dashboard/rag-kb.js',
  '/dashboard/recipes.js',
  '/dashboard/mobile.js',
