...
const TOPIC_KEYWORDS = {
  ...
  lifeos: ['life os', 'rencana hari ini', 'kerjakan sekarang', 'daily plan', 'weekly plan', 'ringkasan minggu'],
  habit: ['habit', 'kebiasaan', 'rutinitas', 'rutinitas belajar', 'tiap malam'],
  reminder: ['reminder', 'ingatkan', 'pengingat'],
  focus_session: ['focus session', 'fokus belajar', 'focus block', 'pomodoro'],
  mood_note: ['catat mood', 'mood saya', 'capek hari ini', 'energy saya', 'energi saya'],
  personal_goal: ['personal goal', 'tujuan pribadi', 'ingin fokus', 'ingat saya ingin'],
