...
function buildCommandCatalog() {
  return {
    ...
    agents: ['/bots', '/botstatus', '/botinfo <botId>', '/agents', '/agent <agentId>', '/agentstatus', '/agentprofile <agentId>', '/agentmemory <agentId>', '/agentremember <agentId> | <text>', '/agentforget <agentId> | <memoryId>', '/agentprefs <agentId>', '/sharedmemory', '/agentlearn <agentId> | <note>', '/agentstyle <agentId>', '/router', '/routermode', '/quiet', '/smart', '/council <topic>', '/debate <topic>', '/allagents <topic>', '/askagents <topic>', '/riskreview <topic>'],
