...
const BUILTIN_COMMANDS = [
  ...
  { name: 'telegramcheck', aliases: ['tgcheck'], module: 'telegram-control', category: 'core', description: 'Diagnose Telegram runtime message normalization and routing', examples: ['/telegramcheck'], riskLevel: 'read_only', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, enabled: true },
  { name: 'webhookcheck', aliases: ['webhook_check'], module: 'telegram-control', category: 'core', description: 'Diagnose Telegram webhook route and multi-bot mapping safely', examples: ['/webhookcheck'], riskLevel: 'read_only', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, enabled: true },
  { name: 'messagecheck', aliases: ['msgcheck'], module: 'telegram-control', category: 'core', description: 'Show the normalized current Telegram message without secrets', examples: ['/messagecheck'], riskLevel: 'read_only', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, enabled: true },
