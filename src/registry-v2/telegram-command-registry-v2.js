...
const BUILTIN_COMMANDS = [
  ...
  { id: 'cmd-devices', command: '/devices', aliases: ['/devicelist'], module: 'devices', description: 'List devices', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleDevices', enabled: true },
  { id: 'cmd-devicehealth', command: '/devicehealth', aliases: ['/devhealth'], module: 'devices', description: 'Device health', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleDeviceHealth', enabled: true },
  { id: 'cmd-pairdevice', command: '/pairdevice', aliases: ['/pair'], module: 'devices', description: 'Pair device', riskLevel: 'medium', requiresOwner: true, requiresAdmin: true, requiresApproval: true, requiresEvaluation: false, handlerName: 'handlePairDevice', enabled: true },
  { id: 'cmd-localnodes', command: '/localnodes', aliases: ['/lnodes'], module: 'local-nodes', description: 'Local nodes', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleLocalNodes', enabled: true },
  { id: 'cmd-localai', command: '/localai', aliases: ['/lai'], module: 'local-integrations', description: 'Local AI status', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleLocalAi', enabled: true },
  { id: 'cmd-nasnode', command: '/nasnode', aliases: ['/nas'], module: 'local-integrations', description: 'NAS node status', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleNasNode', enabled: true },
  { id: 'cmd-tunnelstatus', command: '/tunnelstatus', aliases: ['/tunnel'], module: 'local-integrations', description: 'Tunnel status', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleTunnelStatus', enabled: true },
  { id: 'cmd-workflowstudio', command: '/workflowstudio', aliases: ['/wfs'], module: 'workflow-studio', description: 'Workflow Studio', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleWorkflowStudio', enabled: true },
  { id: 'cmd-workflowparse', command: '/workflowparse', aliases: ['/wfparse'], module: 'workflow-studio', description: 'Parse workflow', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleWorkflowParse', enabled: true },
  { id: 'cmd-workflowvalidate', command: '/workflowvalidate', aliases: ['/wfval'], module: 'workflow-studio', description: 'Validate workflow', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleWorkflowValidate', enabled: true },
  { id: 'cmd-workflowrisk', command: '/workflowrisk', aliases: ['/wfrisk'], module: 'workflow-studio', description: 'Workflow risk', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleWorkflowRisk', enabled: true },
  { id: 'cmd-workflowdryrun', command: '/workflowdryrun', aliases: ['/wfdry'], module: 'workflow-studio', description: 'Dry-run workflow', riskLevel: 'low', requiresOwner: false, requiresAdmin: false, requiresApproval: false, requiresEvaluation: false, handlerName: 'handleWorkflowDryRun', enabled: true },
  { id: 'cmd-workflowproposal', command: '/workflowproposal', aliases: ['/wfprop'], module: 'workflow-studio', description: 'Workflow proposal', riskLevel: 'medium', requiresOwner: false, requiresAdmin: true, requiresApproval: true, requiresEvaluation: false, handlerName: 'handleWorkflowProposal', enabled: true }
];
