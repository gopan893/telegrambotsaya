...
const STABLE_TABS = [
  ...
  { id: 'plugin-hardening', title: 'Plugin Hardening', href: '/plugin-hardening', dataTab: 'plugin-hardening', rendererName: 'plugin-hardening', apiEndpoint: '/api/v2/plugin-hardening', aliases: ['plugin-security', 'plugin-certification', 'connector-hardening', 'plugin-health'], group: 'core', stable: true, publicVisible: true, mobileVisible: true, expectedContentKeywords: ['plugin', 'hardening', 'certification', 'connector'], fallbackMode: 'empty', enabled: true },
  { id: 'rag-quality', title: 'RAG Quality', href: '/rag-quality', dataTab: 'rag-quality', rendererName: 'rag-quality', apiEndpoint: '/api/v2/rag-quality', aliases: ['memory-intelligence', 'memory-quality', 'retrieval-quality', 'citations', 'hallucination-guard'], group: 'business', stable: true, publicVisible: true, mobileVisible: true, expectedContentKeywords: ['rag', 'quality', 'retrieval', 'hallucination', 'citation'], fallbackMode: 'empty', enabled: true },
  { id: 'agent-runtime', title: 'Agent Runtime', href: '/agent-runtime', dataTab: 'agent-runtime', rendererName: 'agent-runtime', apiEndpoint: '/api/v2/agent-runtime', aliases: ['agent-optimization', 'model-strategy', 'model-routing-v2', 'agent-performance', 'model-budget'], group: 'core', stable: true, publicVisible: true, mobileVisible: true, expectedContentKeywords: ['agent', 'runtime', 'model', 'strategy', 'budget'], fallbackMode: 'empty', enabled: true },
  { id: 'devices', title: 'Devices', href: '/devices', dataTab: 'devices', rendererName: 'devices', apiEndpoint: '/api/v2/devices', aliases: ['multi-device', 'local-nodes', 'local-node', 'termux-node', 'mac-node', 'nas-node', 'local-ai-node'], group: 'ops', stable: true, publicVisible: true, mobileVisible: true, expectedContentKeywords: ['devices', 'nodes', 'termux', 'nas'], fallbackMode: 'empty', enabled: true },
  { id: 'workflow-studio', title: 'Workflow Studio', href: '/workflow-studio', dataTab: 'workflow-studio', rendererName: 'workflow-studio', apiEndpoint: '/api/v2/workflow-studio', aliases: ['workflows', 'workflow-builder', 'automation-studio', 'workflow', 'studio'], group: 'automation', stable: true, publicVisible: true, mobileVisible: true, expectedContentKeywords: ['workflow', 'studio', 'automation'], fallbackMode: 'empty', enabled: true }
];
